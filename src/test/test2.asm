...
.proc test_suite_2: near
   ...
   CLOSE_INPUTSTREAM
   ASSERT_VAR_U8_EQUALS_IMM $3001, $00, ZP8_returnCode
   ASSERT_VAR_U16_EQUALS_IMM $3002, $48, ZP16_returnDetail ; $55 * 6 / 7 = $48

   OPEN_INPUTSTREAM_R fn_header_x, 6, '1'
   jsr func_slurp_header
   CLOSE_INPUTSTREAM
   ASSERT_VAR_U8_EQUALS_IMM $3011, RC_UNSUPPORTED_FILE_TYPE, ZP8_returnCode
   ASSERT_VAR_U16_EQUALS_IMM $3012, $AF12, ZP16_returnDetail

   OPEN_INPUTSTREAM_R fn_header_x, 6, '2'
   jsr func_slurp_header
   CLOSE_INPUTSTREAM
   ASSERT_VAR_U8_EQUALS_IMM $3001, $00, ZP8_returnCode
   ASSERT_VAR_U16_EQUALS_IMM $3021, $FE, ZP16_returnDetail

   ;---------------------------------------------------------------------------
   ; TEST 31 - handle_invalid
   ;---------------------------------------------------------------------------
   U16_COPY_IMM v16_chunkType, $DEAD
   jsr handle_invalid
   ASSERT_VAR_U8_EQUALS_IMM $3100, RC_INVALID_CHUNK_TYPE, ZP8_returnCode
   ASSERT_VAR_U16_EQUALS_IMM $3101, $DEAD, ZP16_returnDetail
